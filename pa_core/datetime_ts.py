"""Timezone-safe datetime ↔ epoch helpers for market data.

Ported verbatim from PA_Agent ``pa_agent/data/datetime_ts.py`` (baseline 1090a5b).
Kept as a standalone module so later ported files keep mechanical import
rewrites (``pa_agent.data.datetime_ts`` → ``pa_core.datetime_ts``).
"""
