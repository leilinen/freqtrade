...
Migration note (vs PA_Agent 1090a5b): the trade_records CSV fallback is removed.
Prior decisions come exclusively from the previous AnalysisRecord passed in
(restored from PG by the strategy layer). The CSV-only audit helpers
(load_last_trade_csv_row, audit_relation_fields, classify_vs_previous,
_REL_LABELS_ZH) were dead code without trade_logger and are dropped.
"""
...
from pa_core.util.price_tick import infer_price_tick_from_frame
