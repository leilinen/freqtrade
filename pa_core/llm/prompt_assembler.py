...
from pa_core.llm.decision_stance import build_decision_stance_guidance, normalize_stance
from pa_core.llm.pattern_routing import (
    STAGE1_DETECTED_PATTERNS_GUIDE,
    STAGE1_PATTERN_BRIEFS_BLOCK,
)
from pa_core.features.kline_features import bar_candle_direction_label, compute_kline_geometry_features
from pa_core.features.market_features import (
...
from pa_core.datetime_ts import format_epoch_for_display
...
class PromptAssembler:
    ...
    def _normalize_prev_stage1_assistant_for_incremental(
        ...
        from pa_core.validation.json_validator import format_model_json_for_context
    ...
    def _render_program_prefill_hint(frame: KlineFrame) -> str:
        ...
        *before* making its own judgement.  The AI can still override via
        ...
        """
        try:
            from pa_core.decision.decision_nodes import (
                judge_data_sufficiency,
                judge_direction,
                judge_always_in,
            )
            from pa_core.features.trend_context import (
                build_trend_context,
    ...
    def build_stage2_continuation(
        ...
        *,
        ...
        """
        from pa_core.llm.deepseek_client import supports_kv_prefix_chain
    ...
    def _build_stage2_user_prompt(
        ...
        *,
        ...
        from pa_core.llm.decision_continuity import (
        ...
        from pa_core.util.price_tick import format_breakout_tick_hint
