...
from pa_core.decision.decision_tree import normalize_bar_range, validate_bar_range_field
...
def validate_stage1_coherence(
    ...
    *,
    ...
    from pa_core.llm.pattern_routing import validate_detected_patterns_vs_key_signals
