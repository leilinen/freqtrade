...
from pa_core.validation.coherence_checks import BAR_BY_BAR_TARGET_COUNT
from pa_core.validation.trace_normalize import normalize_stage1_traces
...
def _pad_bar_by_bar_summary_to_minimum(
    ...
    *,
    ...
    from pa_core.features.kline_features import compute_kline_geometry_features
...
def normalize_stage1(
    ...
    *,
    ...
    from pa_core.llm.pattern_routing import ensure_detected_patterns_coherent
    ...
    if kline_frame is not None:
        try:
            from pa_core.features.structure_levels import refresh_stage1_support_resistance
