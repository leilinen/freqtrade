...
from pa_core.validation.trace_normalize import normalize_stage2_traces
from pa_core.util.price_tick import (
...
def _normalize_next_cycle_prediction(
    ...
    *,
    ...
    from pa_core.decision.cycle_enums import CYCLE_ORDER
...
def _fix_background_limit_trace(out: dict[str, Any]) -> bool:
    ...
    try:
        from pa_core.decision.decision_nodes import is_planned_limit_order
    except ImportError:
        return False
...
def normalize_stage2(
    ...
    *,
    ...
    if isinstance(decision, dict):
        from pa_core.util.trade_metrics import adjust_decision_stop_for_tp1_rr_cap
    ...
    if kline_frame is not None:
        try:
            from pa_core.decision.decision_nodes import DecisionNodeEngine
