...
from pa_core.validation.json_validator import Ok
from pa_core.validation.stage2_normalizer import (
...
from tests.pa_core.fixtures.validators import schema_test_validator
...
def test_normalize_decision_reasoning_truncation() -> None:
    ...
    from pa_core.validation.stage2_normalizer import DECISION_REASONING_MAX_LEN, normalize_stage2
...
def test_normalize_stage2_retruncates_after_continuity_guard() -> None:
    ...
    obj = dict(guarded)
    with patch("pa_core.llm.decision_continuity.apply_continuity_guard", side_effect=_fake_guard):
...
def test_coerce_breakout_without_basis_to_limit() -> None:
    from pa_core.validation.stage2_normalizer import _coerce_breakout_without_basis
