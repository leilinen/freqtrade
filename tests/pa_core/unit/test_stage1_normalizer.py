...
from pa_core.validation.coherence_checks import validate_stage1_coherence
...
from tests.pa_core.fixtures.integration_data import VALID_STAGE1
...
def test_repair_gate_result_unknown_to_proceed_when_13_not_chaotic() -> None:
    ...
    from pa_core.validation.trace_normalize import _repair_gate_result
...
def test_rescue_descending_triangle_from_cycle_position() -> None:
    ...
    from pa_core.validation.stage1_normalizer import _rescue_pattern_from_cycle_position
